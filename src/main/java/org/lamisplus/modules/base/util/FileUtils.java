...
public class FileUtils {
    ...
    public void loadFile(String filepath) throws IOException {
        if (filepath.toLowerCase().endsWith(".zip")) {
            ...
            if (directory != null) {
                ...
                File destination = new File("exchange");
                ...
                for (File file : source.listFiles()) {  //iterate through the files in the source directory
                    if (file.getName().toLowerCase().endsWith(".xml")) {
                        ...
                        f.renameTo(new File( "exchange/" + file.getName())); //copy to destination directory
                    }
                }
            }
        }
    ...
    public String readStringFromFile(String filePath) {
        ...
        try {
            ...
            string = org.apache.commons.io.FileUtils.readFileToString(file);
